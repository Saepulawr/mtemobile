...
class ProgressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double percentageWidth = Math.map(this.value, 0, this.maxValue, 0, 1);
    return Container(
      width: width,
      child: Stack(
        children: <Widget>[
          ...
          new Container(
            ...
            decoration: BoxDecoration(
              ...
              color: this.backgroundColor ?? Colors.grey,
              border: Border.all(
          ...
          FractionallySizedBox(
            widthFactor: percentageWidth,
            child: new Container(
              height: this.height,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(50),
                color: this.valueColor ?? Colors.blue,
              ),
            ),
          ),
        ],
